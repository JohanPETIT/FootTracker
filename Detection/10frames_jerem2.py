#découpage 10 frames avec labels en avi 
import os
import pandas as pd
import cv2
...
for video_id in df['video_id'].unique():
    ...
    for i in range(frame_count):
        ...
        if len(frames) == 10:
            ...
            batch_filename = os.path.join(output_path, f"batch{batch_count:03d}_{batch_label}.avi")
            batch_count += 1
            ...
            print(f"Batch {batch_count:03d} of video_id {video_id} with label {batch_label} has been added")
