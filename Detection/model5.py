...
for labeld in set(class_counts.keys()): # class_counts: (<class 'int'>, {1: 77582, 0: 13388, 2: 2293, 3: 578}) .
    ...
    oversample_factor = max_class_count - class_counts[labeld] - 550000 # Determinates if the class needs to be scaled.
...
class SimpleCNN(nn.Module):
    def __init__(self,fc_layer_size):
        ...
        self.fc = nn.Linear(fc_layer_size, 4)  # Fully connected layer for classification
